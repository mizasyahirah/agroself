...
session_start();
  ...
  if(isset($_POST['reset'])){
    ...
    $sql4 =     "SELECT farmer_id, question1, question2 
           FROM farmer WHERE question1 = '$question1' and question2 = '$question2' ";
...
<body>
      ...
      <table align = "center" border="0" cellpadding="7" cellspacing="0" >
        <tr>
        <td>Question 1</td>
        <td><input class="input" type="text" name="question1" autofocus required placeholder="What is your secret word ?" ></td>
        </tr>
        
        <tr>
        <td>Question 2</td>
        <td><input class="input" type="text" name="question2" placeholder="What a favourite name you like ?"></td>
        </tr> 
