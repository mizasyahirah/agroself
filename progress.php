...
$sql =    "SELECT  orders.weightA , orders.weightB, orders.status, orders.date, orders.productfarmer_id, productfarmer.product_id, product.product_name, seller_id 
FROM productfarmer, product, orders 
...
<head>
	...
	<div class="Mcontent">
		...
		<table align="center" border="0" width="60%" cellpadding="0" cellspacing="0">
		  <td><hr></td>
		  <td width="30%" align="center"><h2><font color="#1168da">Progress of Order</font></h2></td>
		  <td><hr></td>
		</table>
		...
		<table align="center" border="0" width="70%" cellpadding="5" cellspacing="0">
			<tr align="center">
			  ...
			  <td width="30%"  style="background-color: #a6a6a6;">Status</td>          
			</tr>
		...
		<tbody id="myTable">
			<tr>
			  ...
			  <td style="border-bottom: 1px solid #b3b3b3;" align="center"><?php echo $row["status"]; ?></td>
			  <td><br><br></td>
			</tr>
		</tbody>
		<?php $rowNumber++; } ?>
